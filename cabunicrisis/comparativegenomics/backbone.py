...
from FastANI.fastANI_wrapper import fastANI_runner
from FastANI.fastANI_wrapper import fastANI_classify
from MLST.mlst_wrapper import mlst
from MLST.mlst_viz import mlst_viz
from kSNP.kSNP_wrapper import kSNP_runner
from kSNP.make_phylogeny import read_TreeFile
from kSNP.make_phylogeny import Generate_NormalTree
...
def check_tools(run_tool):
    tools_to_run=[]
    if(run_tool==1):
        tools_to_run.append("fastANI")
    elif(run_tool==2):
        tools_to_run.append("mlst")
    elif(run_tool==3):
        tools_to_run.append("kSNP")
