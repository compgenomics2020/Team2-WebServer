...
def blastn_script(input_path, input_file_folder, output_path,run_tool):
    ...
    if run_tool=="3":
        ...
        input_file=input_path+input_file_folder+"/"+input_file_folder+"_nucleotide.fnn"
    ...
    if "totaldb.fna.nhr" not in os.listdir("/home/projects/group-b/gene_prediction/codes/mycodes/coding/total_campylobacter/"):       #if no database exists in blast database directory
        print("BLAST database does not exists in specified directory, Making a new blast database")
        subprocess.call("makeblastdb -in /home/projects/group-b/gene_prediction/codes/mycodes/coding/total_campylobacter/totaldb.fna -dbtype nucl",shell=True)
        #blast_db = the location of the blast custom database
        blast_db ="/home/projects/group-b/gene_prediction/codes/mycodes/coding/total_campylobacter/totaldb.fna"
    else:
        #blast_db = the location of the blast custom database
        blast_db ="/home/projects/group-b/gene_prediction/codes/mycodes/coding/total_campylobacter/totaldb.fna "
